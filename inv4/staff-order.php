...
<?php include 'alert-file.php'; ?>
  ...
  <div class="order-buttons">
    <button id="customer-modal-btn">Select User</button>
    <button id="product-modal-btn">Add Stock</button>
    <button id="clear">Clear</button>
    <a href="dash-print-order.php" id="orders-list-a">Stock List</a>
  </div>
  ...
  <div class="order-total">
        ...
        <button type="submit" name="add_order" id="create-order-btn">Update Stock</button>          
  </div>
</form>
</div>
