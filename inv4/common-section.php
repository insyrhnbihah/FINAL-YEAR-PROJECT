...
if($user_role == 'admin'){
    $manage_users = '<li><a href="dash-user.php"><i class="fas fa-user"></i>Users</a></li>
                     <li><a href="dash-stock-list.php"><i class="fas fa-file-invoice-dollar"></i>Manage Stock</a></li>
                    ';

}

// <li><a href="dash-order.php"><i class="fas fa-shopping-cart"></i>Stock</a></li>
